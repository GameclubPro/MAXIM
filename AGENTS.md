...
- CDN/app2 mini app delivery is paused. Treat `https://major-maksimov.ru/` as the active user-facing host and `https://major-maksimov.ru/app/` as the only routine mini app deploy/smoke target. Leave CDN/app2/Object Storage logic dormant and unchanged for routine work: do not change, publish, or smoke Object Storage, Yandex CDN, `app2.major-maksimov.ru`, or restricted-LTE delivery unless the user explicitly resumes CDN work.
...
- Use `https://major-maksimov.ru/` as the primary user-facing host and `https://major-maksimov.ru/app/` as the primary direct mini app URL while CDN/app2 delivery is paused. Keep CDN/Object Storage/app2 logic dormant for routine work: do not publish Object Storage, adjust Yandex CDN delivery, or run `app2.major-maksimov.ru` smokes unless the user explicitly resumes CDN/restricted-LTE work.
