...
- For user profile/contact buttons, prefer existing `profileHandoffUrl` / profile-mention handoff links over public `profileUrl`; most MAX users do not have a public username/profile URL.
