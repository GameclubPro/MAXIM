...
- Global spammer observations, scoring, suppression, and review decisions live in `GlobalSpammerIntelligenceService`; admin review endpoints should stay in `ManualModerationService` instead of growing legacy `AdminService`.
