...
- For sanitized commercial corpus exports, pass `--export-corpus-jsonl <path>` to the audit command and validate gates with `npm run moderation:validate-commercial-corpus --workspace @maxim/api -- --input <path>`.
