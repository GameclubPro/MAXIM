...
const baseScenarios = [
  ...
  ...defineRouteScenarios('publications', [
    ...
    [
      ...
      { searchParams: { profile: 'publisher', view: 'history' }, features: ['publisher'] },
    ],
    [
    ...
    [
      'publications-publisher-post-actions',
      {
        searchParams: { profile: 'publisher', compose: '1' },
        features: ['publisher', 'broadcast'],
      },
  ...
  ...defineRouteScenarios('chat-events', [
    ...
    ['events-participants-empty', { searchParams: { section: 'participants' } }],
    ['events-participants-bots', { searchParams: { section: 'participants' } }],
  ...
  ...defineRouteScenarios('chat-settings', [
    ...
    ['chat-settings-advertising-pilot', { searchParams: { advertisingPilot: '1' } }],
    [
