...
// Small headroom for MAX-native comment surfaces, backdrop ornaments, and cross-environment gzip drift.
const STARTUP_CSS_BUDGET_GZIP = Math.round(35 * 1024) + 1984;
