...
// confirm flow, plus visual markdown preview rendering in compact broadcast
// cards and sheets, add a small amount of legitimate lazy-loaded logic.
const SETTINGS_JS_BUDGET_GZIP = 108 * 1024 + 4096;
