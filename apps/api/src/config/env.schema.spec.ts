...
describe('validateEnv boolean parsing', () => {
  ...
  it('keeps general delete intents off while enabling the narrow replacement cleanup switch', () => {
    ...
    expect(defaults.MODERATION_DELETE_INTENT_REQUIRED_SUBSCRIPTION_ENABLED).toBe(false);
    ...
    expect(canary.MODERATION_DELETE_INTENT_REQUIRED_SUBSCRIPTION_ENABLED).toBe(true);
