...
export const MANAGED_BROADCAST_LOCK_STALE_MS = 60_000;
...
export const MANAGED_ENTITIES_REFRESH_UNCACHED_LIMIT = 40;
...
export const MANAGED_ENTITIES_LOCAL_REFRESH_SCAN_WINDOW_SIZE = 8;
...
export const MANAGED_POLL_ACTION_UPDATE = 'UPDATE_MANAGED_POLL';
export const MANAGED_POLL_ACTION_PUBLISH = 'PUBLISH_MANAGED_POLL';
export const MANAGED_POLL_ACTION_CLOSE = 'CLOSE_MANAGED_POLL';
...
export const MANAGED_ENTITIES_LOCAL_CANDIDATE_LIMIT = 250;
...
export const LOCAL_USER_DISPLAY_NAME_EVENT_TYPES = [
