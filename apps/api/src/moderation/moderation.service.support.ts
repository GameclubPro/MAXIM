...
export const REQUIRED_SUBSCRIPTION_FOLLOW_UP_DETACH_MIN_REMAINING_MS = 3_500;
export const REQUIRED_SUBSCRIPTION_FOLLOW_UP_HOT_PATH_TIMEOUT_MS = 2_000;
...
export const CHANNEL_ENGAGEMENT_REPLY_TEXT = 'Действия к публикации';
