...
export const NIGHT_MODE_OPEN_NOTICE_RULE_CODE = 'NIGHT_MODE_OPEN_NOTICE';
...
export const REQUIRED_SUBSCRIPTION_NOTICE_COOLDOWN_SEC = 15 * 60;
export const REQUIRED_SUBSCRIPTION_CHANNEL_METADATA_CACHE_TTL_MS = 10 * 60_000;
export const DEFAULT_REQUIRED_SUBSCRIPTION_HOT_PATH_CHANNEL_LIMIT = 3;
...
export const NIGHT_MODE_SESSION_MARKER_TTL_SEC = 2 * 24 * 60 * 60;
...
export const DEFAULT_NIGHT_MODE_SCHEDULED_NOTICE_SPACING_MS = 150;
...
export const CHAT_COMMENTS_REPLY_TEXT = 'Открыть комментарии';
export const CHANNEL_FORWARD_REPLY_TEXT = 'Действия к посту';
...
export const GLOBAL_SPAMMER_WARN_MIN_CHATS = 5;
export const GLOBAL_SPAMMER_HIGH_FANOUT_MIN_CHATS = 6;
export const GLOBAL_SPAMMER_WARN_THRESHOLD = 2;
export const GLOBAL_SPAMMER_WARN_COUNTER_TTL_SEC = 7 * 24 * 60 * 60;
